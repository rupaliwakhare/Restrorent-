      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="flex flex-col  md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full rounded border-gray-500 px-3 py-2 
               mt-1.5 outline-none"
                required
              />
            </div>
        ...
        <div className="mt-25 space-y-4">
          {roomCommonData.map((spec, index) => (
            <div kay={index} className="flex items-start gap-2">
              <img
                src={spec.icon}
                alt={`${spec.title}-icon`}
                className="w-6.5"
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            city feeling. The price quoted is for two Guest, async function the
            guest slot please mark the number of guests to get the exact price
            for groups. The Guestss wull be allocated ground floor according to
